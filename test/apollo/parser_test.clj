(ns apollo.parser-test
  (:require [clojure.test :refer :all]
            ...
            [apollo.constants-test :refer :all]))
...
(deftest get-score-notes-test
  (let [score (slurp "test/apollo/testscore.apl")]
    (is (= (get-score-notes score) "c4 d e f2 g a b c c b a g f e d c"))))
...
(deftest get-score-octave-test
  (let [score-metadata (get-score-metadata (slurp "test/apollo/testscore.apl"))]
    (is (= (get-score-octave score-metadata) 4))))
...
(deftest apl-score-from-file-test
  (is (= (apl-score-from-file "test/apollo/testscore.apl") apl-testscore)))
